...
public class sounds_category_music extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupSound(recomm.getChildAt(2), new SoundItem("Žalosna violina", "https://cdn.pixabay.com/download/audio/2022/03/15/audio_a14e4323c7.mp3?filename=mournful-violin2-77967.mp3", R.drawable.mythforest_sound));
        setupSound(recomm.getChildAt(3), new SoundItem("Džez", "https://cdn.pixabay.com/download/audio/2022/03/14/audio_ec774acb0e.mp3?filename=late-jazz-piano-pure-62449.mp3", R.drawable.wind_sound));
        setupSound(recomm.getChildAt(4), new SoundItem("Violina i klavir", "https://cdn.pixabay.com/download/audio/2022/03/09/audio_9d10759f65.mp3?filename=piano_violin-freesound-26340.mp3", R.drawable.night_sound));
