...
public class vjezba_disanja2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vjezba_disanja2);
        ...
        buttonnext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Navigation.findNavController((Activity) getApplicationContext(), R.id.meditacijaFragmentView).navigate(R.id.action_vjezba_disanja2_to_osnovna_meditacija_korak3);
            }
        });
