...
public class sounds_category_ambijent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupSound(list1.getChildAt(1), new SoundItem("Otkucavanje sata","https://cdn.pixabay.com/download/audio/2022/03/09/audio_4b7bb9d4c1.mp3?filename=ticking-clock_1-27477.mp3", R.drawable.otkucavanje_sata_sound));
        setupSound(list1.getChildAt(2), new SoundItem("Pranje ruku","https://cdn.pixabay.com/download/audio/2022/03/10/audio_2b5ec30ccd.mp3?filename=washing-hands-in-kitchen-sink-30759.mp3",R.drawable.pranje_ruku_sound));
