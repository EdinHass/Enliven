...
public class HabitHelperDB {
    ...
    private static SharedPreferences preferences;
        ...
        public HabitHelperDB(Context appContext) {
        ...
        public ArrayList<HabitsDomain> getListObject(String key){
            Gson gson = new Gson();

            ArrayList<String> objStrings = getListString(key);
            ArrayList<HabitsDomain> playerList =  new ArrayList<HabitsDomain>();

            for(String jObjString : objStrings){
                HabitsDomain player  = gson.fromJson(jObjString,  HabitsDomain.class);
        ...
        public static void putListObject(String key, ArrayList<HabitsDomain> playerList){
            checkForNullKey(key);
            Gson gson = new Gson();
            ArrayList<String> objStrings = new ArrayList<String>();
            for(HabitsDomain player: playerList){
