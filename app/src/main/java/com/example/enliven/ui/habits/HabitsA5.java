...
public class HabitsA5 extends RecyclerView.Adapter<HabitsA.ViewHolder> {
    ArrayList<HabitsDomain> habitsDomains;

    public HabitsA5(ArrayList<HabitsDomain> habitsDomains) {
